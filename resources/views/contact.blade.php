...
<div class="container my-12 mx-auto px-2 md:px-4 bg-base-100">
    ...
    <section class="mb-32">
        ...
        <div class="flex flex-wrap">
            ...
            <form class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                ...
                <button type="button"
                        class="mb-6 inline-block w-full rounded btn-logo px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-teal-500">
                        Send
                </button>
